...
class Compose_Horizontal_CustomAdapter extends RecyclerView.Adapter<Compose_Horizontal_CustomAdapter.MyViewHolder> {

    private ArrayList<Compose_Data_Model> dataSet;
...
*/
    ...
    public Compose_Horizontal_CustomAdapter(ArrayList<Compose_Data_Model> data) {
        this.dataSet = data;
    }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.compose_cardview_mainpage, parent, false);
